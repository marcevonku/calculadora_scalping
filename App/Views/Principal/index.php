    ...
    <div class="container">
        ...
        <div class="tab-content">
            ...
            <div id="solapa2" class="tab-pane">
                <h3>
                    <div class="section-header">
                        📈 Calculos de Operaciones: Entrada / in - out - Netos - Compras - ventas
                    </div>
                </h3>
                <p>
                <div class="container">
                    <!-- Sección 1: Datos de Comparación -->
                    <div class="section">
                        <div class="section-header">
                            📈 Datos de Comparación: Brokers, Porcentajes, Proyección, Punto Equilibrio, Bruto Compra,
                            Bruto Venta
                        </div>
                        <div class="section-content">
                            <div class="form-grid">
                            ...
                            <form id="brokerConfigForm">
                                ...
                                <div class="form-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="valorNeto" step="0.01"
                                            oninput="calcularCoeficienteBase()">
                                    </div>
                                </div>
                                <div class="form-grid">
                ...
                <div class="container">
                        ...
                        <table class="calculation-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="comisionCompraDisplay" class="readonly" readonly></td>
                                    <td><input type="text" id="comisionCompraTotal" class="readonly" readonly></td>
                                </tr>
                                <tr>
                                    <td>Derecho Mercado</td>
                                    <td><input type="text" id="derechoMercadoDisplay" class="readonly" readonly></td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="gananciaProyectadaTotal" class="readonly" readonly></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="derechoMercadoVentaDisplay" class="readonly" readonly>
                                    </td>
                                    <td><input type="text" id="derechoMercadoVentaTotal" class="readonly" readonly></td>
                                </tr>
                                <tr>
                                    <td>IVA Venta</td>
                    ...
                    <!-- Sección 3: Calculadora de Operaciones -->
                    <div class="section">
                        <div class="section-header">
